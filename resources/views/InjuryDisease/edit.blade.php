...
<div class="container">
    ...
    <div class="content">
        {!! Form::model($injurydiseases,['method'=>'PUT','route' => ['InjuryDisease.update', $injurydiseases->id]]) !!}
    @csrf
    <div class="user-details">
            <div class="input-box">
                {{ Form::label('health_problem', 'Injury/Disease Name') }}
                {{ Form::text('health_problem', $injurydiseases->health_problem, ['class' => 'form-control']) }}
            </div>
    </div>
