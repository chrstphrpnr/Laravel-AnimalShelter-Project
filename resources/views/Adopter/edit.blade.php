...
<div class="container">
    <div class="title">Edit Record</div>
        <div class="content">
         {!! Form::model($adopters,['method'=>'PUT','route' => ['Adopter.update', $adopters->id]]) !!}
            @csrf
            ...
            <div class="user-details">
                ...
                <div class="input-box">
                    ...
                    {{ Form::text('adopter_fname', $adopters ->adopter_fname, ['class' => 'form-control']) }}
                </div>


                <div class="input-box">
                    {{ Form::label('Last Name') }}
                    {{ Form::text('Lname', $adopters ->Lname, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                    {{ Form::label('Age') }}
                    {{ Form::text('Age', $adopters ->Age, ['class' => 'form-control']) }}
                </div>


                <div class="input-box">
                    {{ Form::label('Address') }}
                    {{ Form::text('Address', $adopters ->Address, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                    {{ Form::label('Contact') }}
                    {{ Form::text('Contact', $adopters ->Contact, ['class' => 'form-control']) }}
                </div>
            </div>

            <div class="Gender-details">
                <span class="Gender-title">Gender</span>
                @if($adopters->Gender == 'Male')
            ...
            <div class="array">
                @if(in_array($animal_id, $animaladopters))
