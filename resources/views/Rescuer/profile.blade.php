            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                            ...
                            <td>
                            <a href="{{ route('rescuerprofile.edit', $rescuer->id)}}" title="Edit" class="edit"><span class="material-icons">edit</span></a>
                            </td>
                        </tr>
                        {{-- @endforeach --}}
                    </tbody>
