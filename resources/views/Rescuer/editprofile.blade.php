...
<div class="container">
    ...
    <div class="content">
    {!! Form::model($rescuer,['method'=>'POST','route' => ['rescuerprofile.update', $rescuer->id]]) !!}
        @csrf
        ...
        <div class="user-details">
                ...
                <div class="input-box">
                    ...
                    {{ Form::text('rescuer_fname', $rescuer ->rescuer_fname, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                    {{ Form::label('Last Name') }}
                    {{ Form::text('Lname', $rescuer ->Lname, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                    {{ Form::label('Age') }}
                    {{ Form::text('Age', $rescuer->Age, ['class' => 'form-control']) }}
                </div>


                <div class="input-box">
                    {{ Form::label('Address') }}
                    {{ Form::text('Address', $rescuer ->Address, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                    {{ Form::label('Contact') }}
                    {{ Form::text('Contact', $rescuer ->Contact, ['class' => 'form-control']) }}
                </div>
