        ...
        <div class="content">
            ...
            <div class="user-details">
                ...
                <div class="input-box">
                    ...
                    {{ Form::text('personnel_fname', $personnel ->personnel_fname, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                     {{ Form::label('Last Name') }}
                    {{ Form::text('Lname', $personnel ->Lname, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                    {{ Form::label('Email') }}
                    {{ Form::text('Email', $personnel->Email, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                    {{ Form::label('Age') }}
                    {{ Form::text('Age',$personnel->Age, ['class' => 'form-control']) }}
                </div>


                <div class="input-box">
                    {{ Form::label('Address') }}
                    {{ Form::text('Address', $personnel ->Address, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                    {{ Form::label('Contact') }}
                    {{ Form::text('Contact', $personnel ->Contact, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                    {{ Form::label('Password') }}
                    {{ Form::text('Password', $personnel->Password, ['class' => 'form-control']) }}
                </div>

                <div class="input-box">
                    {{ Form::label('Role') }}
                    {{ Form::text('Role', $personnel->Role, ['class' => 'form-control']) }}
                </div>
            </div>
