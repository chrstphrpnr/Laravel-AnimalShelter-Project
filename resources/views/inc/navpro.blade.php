    ...
    <nav class="navbar navbar-expand-lg fixed-top py-3">
        {{-- <div class="container"><img src="https://image.flaticon.com/icons/png/512/290/290341.png" width="45" alt="" class="d-inline-block align-middle mr-2"><a href="/homepage" class="navbar-brand text-uppercase font-weight-bold">SHAW SHELTER</a>
            ...
            <div id="navbarSupportedContent" class="navbar">
                <ul class="navbar-nav">
                    <li class="nav-item"><a href="/user/signup" class="nav-link text-uppercase font-weight-bold">Register</a></li>
                    <li class="nav-item"><a href="/user/signin" class="nav-link text-uppercase font-weight-bold">Login</a></li>
                </ul>
            </div>
        </div>
    </nav>
